...
def parse_stim_repr(
    ...
    """ Read the string representation of a psychopy stimulus and
...
def extract_const_params_from_stim_repr(
    ...
    (usually because they are not varied during the course of the session)
    are not output in an easily machine-readable format. This function
