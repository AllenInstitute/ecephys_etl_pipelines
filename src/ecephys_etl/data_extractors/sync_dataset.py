...
Obtained from:
https://github.com/AllenInstitute/AllenSDK/blob/master/allensdk/brain_observatory/sync_dataset.py

Which in turn was originally likely sourced from:
http://stash.corp.alleninstitute.org/projects/ENG/repos/sync/browse/sync/dataset.py
...
class Dataset(object):
    ...
    def plot_monitor_lag(self,
        ...
        current = plt.gca()
        current.axes.yaxis.set_ticklabels([])
        current.set_ylim([-1, 1])
