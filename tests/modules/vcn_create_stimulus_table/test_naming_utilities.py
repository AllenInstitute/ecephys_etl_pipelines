...
from ecephys_etl.modules.vcn_create_stimulus_table import (
...
@pytest.mark.parametrize(
    ...
    [
        [
            pd.DataFrame({
                "stimulus_name": [
                        "natural_movie_4", "natural_movie_5_more_repeats"
                    ]
            }),
            pd.DataFrame(
                {
...
@pytest.mark.parametrize(
    ...
    [
        [
            pd.DataFrame({
                "stimulus_name": [
                    "Natural Images", "contrast_response"
                ]
            }),
            {
        ...
        [
            pd.DataFrame({
                "stimulus_name": [
                    "Natural Images", "contrast_response", np.nan
                ]
            }),
            {
                "Natural Images": "natural_scenes",
