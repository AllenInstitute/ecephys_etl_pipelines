...
from ecephys_etl.modules.vcn_create_stimulus_table.__main__ import (
    build_stimulus_table
)


def build_pseudofixture(name, data):
    new_class = collections.namedtuple(name, data.keys())
    return new_class(**data)


def stim_file(*a, **k):
    return build_pseudofixture(
        "StimFileClass",
        {
            "pre_blank_sec": 20.0,
            ...
            "stimuli": [
                {
                    "stim_path": "C:\\ecephys_stimulus_scripts\\gabor_20_deg_250ms.stim",  # noqa: E501
                    ...
                    "stim": "GratingStim(autoDraw=False, autoLog=True, contrast=0.8, win=Window(...))",    # noqa: E501
                },
                {
                    "stim_path": "C:\\ecephys_stimulus_scripts\\static_gratings.stim",    # noqa: E501
                    ...
                    "stim": "GratingStim(contrast=0.8, ori=30.0, phase=array([0., 0.]), sf=array([0.16, 0.16]), size=array([250., 250.]))",   # noqa: E501
                },
            ],
        },
    )
...
@mock.patch(
    "ecephys_etl.data_extractors.stim_file.CamStimOnePickleStimFile.factory",
    new=stim_file,
)
@mock.patch(
    "ecephys_etl.data_extractors.ecephys_sync_dataset"
    ".EcephysSyncDataset.factory",
    new=sync_file(),
)
def test_build_stimulus_table(tmpdir_factory, expected_table):
    ...
    build_stimulus_table(
        ...
        maximum_expected_spontaneous_activity_duration=99999999999,
        stimulus_name_map={
            "": "spontaneous",
    ...
    pd.testing.assert_frame_equal(
        expected_table, obtained_table, check_like=True, check_dtype=False
    )
