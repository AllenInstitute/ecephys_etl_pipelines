...
def test_trim_discontiguous_vsyncs(vs_times, expected):
    obtained = stimulus_sync.trim_discontiguous_times(vs_times)
    assert np.allclose(obtained, expected)


# manual test cases for compute_frame_times, allocate_by_vsync, assign_to_last
@pytest.mark.parametrize(
    'photodiode_times,frame_duration,num_frames,cycle,vsyncs,expected',
    [
        ...
        [
            ...
            [
                np.array([
                    ...
                    6.75, 7.00, 7.25, 7.25, 7.50, 7.75
                ]),
                np.array([
                    5.25, 5.50, 5.75, 6.00, 6.25, 6.75,
                    7.00, 7.25, 7.25, 7.50, 7.75, 8.00
                ]),
            ]
        ],
        ...
        [
            ...
            np.array([
                4.9, 5.15, 5.4, 5.65, 5.9, 6.15, 6.4,
                6.65, 6.9, 7.15, 7.4, 7.65, 7.9
            ]),
            [
                np.array([
                    5.00, 5.25, 5.50, 5.75, 6.00, 6.25,
                    6.50, 6.75, 7.0, 7.25, 7.50, 7.75
                ]),
                np.array([
                    5.25, 5.50, 5.75, 6.00, 6.25, 6.50,
                    6.75, 7.0, 7.25, 7.50, 7.75, 8.00
                ])
            ]
        ],
        ...
        [
            ...
            np.array([
                4.9, 5.15, 5.4, 5.65, 5.9, 6.15, 6.4,
                6.65, 7.15, 7.4, 7.65, 7.9, 8.15
            ]),
            [
                np.array([
                    5.00, 5.25, 5.50, 5.75, 6.00, 6.25,
                    6.50, 6.75, 7.25, 7.50, 7.75, 8.00
                ]),
                np.array([
                    5.25, 5.50, 5.75, 6.00, 6.25, 6.50,
                    6.75, 7.25, 7.50, 7.75, 8., 8.25
                ])
            ]
        ],
        ...
        [
            ...
            np.array([
                4.9, 5.15, 5.4, 5.65, 5.9, 6.15,
                6.4, 6.9, 7.15, 7.4, 7.4, 7.65, 7.9
            ]),
            [
                np.array([
                    5.00, 5.25, 5.50, 5.75, 6.00, 6.25,
                    6.50, 7.0, 7.25, 7.50, 7.50, 7.75
                ]),
                np.array([
                    5.25, 5.50, 5.75, 6.00, 6.25, 6.50,
                    7.0, 7.25, 7.50, 7.50, 7.75, 8.00
                ])
            ]
        ],
        ...
        [
            ...
            np.array([
                4.9, 5.15, 5.4, 5.65, 5.9, 6.15, 6.4,
                6.65, 6.65, 6.9, 7.15, 7.4, 7.65, 7.9
            ]),
            [
                np.array([
                    5.00, 5.25, 5.50, 5.75, 6.00, 6.25,
                    6.50, 6.75, 6.75, 7.0, 7.25, 7.50
                ]),
                np.array([
                    5.25, 5.50, 5.75, 6.00, 6.25, 6.50,
                    6.75, 6.75, 7.0, 7.25, 7.50, 7.75
                ])
            ]
        ],
    ]
...
def test_compute_frame_times(
    ...
    obt_indices, obt_starts, obt_ends = stimulus_sync.compute_frame_times(
        photodiode_times, frame_duration, num_frames, cycle, cb
    )
...
@pytest.mark.parametrize('pd_times,ndevs,cycle,max_offset,expected', [
    ...
    [
        np.concatenate(
            [
                [0, 1, 2, 3, 3.95, 4, 4.1, 4.7, 9, 10, 11],
                np.arange(12, 1000)
            ]
        ),
        0.1, 60, 5,
...
def test_fix_unexpected_edges(pd_times, ndevs, cycle, max_offset, expected):
    obtained = stimulus_sync.fix_unexpected_edges(
        pd_times, ndevs, cycle, max_offset
    )
    assert np.allclose(obtained, expected)
...
@pytest.mark.parametrize('ends,frame_duration,irregularity,expected', [
    [
        ...
        0.5,
        1,
        np.concatenate([np.arange(19), [19.5]])
    ]
])
def test_assign_to_last(ends, frame_duration, irregularity, expected):
    _, obt_ends = stimulus_sync.assign_to_last(
        None, None, ends, frame_duration, irregularity, None
    )
    assert np.allclose(obt_ends, expected)


@pytest.mark.parametrize(
    'vs_diff,index,starts,ends,frame_duration,irregularity,cycle,expected',
    [
        [
            [1, 1, 1, 1, 2, 1, 1, 1, 1],
            1,
...
def test_allocate_by_vsync(
    vs_diff, index, starts, ends, frame_duration,
    irregularity, cycle, expected
):
    obt_starts, obt_ends = stimulus_sync.allocate_by_vsync(
